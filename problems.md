...
48. [TODO] `medium` - Invalid/malformed memo activity is not visible to operators  
...
49. [TODO] `low` - OpenAPI memo contract is underspecified and not machine-enforced  
